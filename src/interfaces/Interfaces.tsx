...
export interface FilterEditor {
  ...
  optionsComponent?: React.ElementType<{ onAddFilter: (name: string) => void, options: Array<Options> }>
}

interface InterfaceConfigButtons {
  add: { text: string, icon?: string },
  remove: { text: string, icon?: string, removeComponent?: React.ElementType<{ onAction: () => void }>; },
  filterActive: { icon?: string, filterActiveComponent?: React.ElementType<{ onAction: () => void }>; },
  filterDisabled: { icon?: string, filterDisabledComponent?: React.ElementType<{ onAction: () => void }>; },
}
...
export interface InterfaceComponentCustom {
  component: React.ElementType<{ onAction: () => void; }>;
  onAction: () => void;
}
...
export interface InterfaceComponentOptions {
  ...
  component: React.ElementType<{ onAddFilter: (name: string) => void, options: Array<Options> }>;
}
