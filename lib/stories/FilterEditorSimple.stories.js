...
const FilterSimple = () => {
    ...
    return (react_1.default.createElement(FilterEditorWrapper_1.FilterEditorWrapper, { values: data, options: options, onChangeValues: setData }));
};
