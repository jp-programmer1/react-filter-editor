...
//@ts-ignore
react_1.default.createElement("select", { name: data.name, id: data.name, className: className, value: data.value, onChange: (e) => onChange(e.target.value) }, data.options && data.options.map(op => (
//@ts-ignore
